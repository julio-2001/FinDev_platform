                    ...
                    <table class="min-w-full border-collapse block md:table">
                        ...
                        <tbody class="block md:table-row-group ">
                            ...
                            <tr class="bg-white border border-grey-500 md:border-none block md:table-row">
                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Vaga:</span>{{$jobApp -> job -> title}} | ID: {{$jobApp -> job -> id}} | local: {{$jobApp -> job -> locationsName -> location}} </td>
                                ...
                                <td class="p-2 md:border md:border-grey-500 text-left md:text-center block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">score</span>{{$jobApp -> score}}</td>
