                ...
                <div class="card-body">
                    ...
                    <table class="min-w-full border-collapse block md:table">
                        <thead class="block md:table-header-group">
                            ...
                            <th class="bg-gray-600 p-2 text-white text-center font-bold md:border md:border-grey-500 text-left block md:table-cell">ID</th>
                        ...
                        <tbody class="block md:table-row-group ">
                            ...
                            @foreach ($jobs as $job )
                                ...
                                <td class="p-2 md:border md:border-grey-500 text-center  block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">ID</span>{{$job -> id}}</td>
                                    ...
                                    <td class="p-2 md:border md:border-grey-500 text-left md:text-center block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold text">Nivel</span>{{$job -> experience}}</td>
